...
public class InMemoryTldLocationsCache extends TldLocationsCache{
    ...
    private void scanWebInf() throws Exception {
        ...
        BytesBasedClassLoader loader = 
        	(BytesBasedClassLoader)webAppClassLoader.getWebInfClassLoader();
        
        Map<URL,Resource> resourceMap = loader.getResources();
     ...
     */
    private void mappingTldResource(Resource res)
            throws Exception {
